...
import { valores, frentes, projetos, impacto, accent } from '@/lib/institucional'
        ...
        <section id="sobre" className="border-t border-line bg-surface px-6 py-20 sm:py-24">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10">
              <Link
                href="/sobre"
                className="inline-flex items-center gap-2 text-sm font-semibold text-sol transition-colors hover:text-paper"
              >
                Saiba mais sobre o IPI <span aria-hidden="true">→</span>
              </Link>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10">
              <Link
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-sol transition-colors hover:text-paper"
              >
                Ver todas as frentes <span aria-hidden="true">→</span>
              </Link>
            </div>
          </div>
        </section>
